...
Desarrollar una aplicación móvil multiplataforma utilizando C#, Blazor, .NET MAUI y SQLite, cuyo objetivo sea administrar un grupo de personas, organizar sus actividades por categorías y registrar las asistencias.
...
La información del teléfono debe considerarse un dato importante y debe ser obligatorio según el requerimiento.
...
Permitirá administrar todos los integrantes.
...
En lugar de tener únicamente una pantalla de reportes, dividiría las consultas en diferentes opciones.
...
Para C#, Blazor, .NET MAUI y SQLite, recomiendo separar la aplicación en varias capas.
